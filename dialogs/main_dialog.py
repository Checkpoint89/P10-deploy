...
class MainDialog(ComponentDialog):
    ...
    async def final_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
        ...
        if step_context.result is not None:
            ...
            msg_txt = f"I have you booked to {result.destination} " \
                f"from {result.origin} on {result.travel_start_date}, "\
                f"return on {result.travel_end_date} for less than {result.budget}"
